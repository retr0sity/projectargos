...
public class AutoScenePortal : MonoBehaviour
{
    ...
    void OnTriggerEnter2D(Collider2D other)
    {
        ...
        Vector3 returnPos = customReturnPoint != null
            ? customReturnPoint.position
            : transform.position;
        ...
        Debug.Log($"[AutoPortal] Transporting to {targetSceneName}, return point saved at {returnPos}");
